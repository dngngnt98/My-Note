...
<body class="subpage">
					...
					<div class="6u 12u$(medium)">
						...
						<div class="col align-center">
							<div class="image round fit">
								<img
									src="${pageContext.servletContext.contextPath}/resources/images/fb-chatbot.png"
									alt="" />
							</div>
	...
	<!-- Scripts -->
	<script
		src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery-1.10.2.min.js"></script>
	<script
