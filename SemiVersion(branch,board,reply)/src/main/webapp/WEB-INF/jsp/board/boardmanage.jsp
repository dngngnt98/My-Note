...
$(function(){
	$(#sencMbtn).click(function(boardType){
		location.href = '../boardmanage/thingUpdate?boardType='+${boardmanage.boardType};
	})
})
</script>
</head>
								...
								<div class="col-xs-12">
									...
									<table id="simple-table"
										...
										<tbody id="store-tbody">
											<c:forEach items="${boardInfo}" var="item">
												<!-- 객체 전체에 걸쳐 반복 실행? /c:forEach까지 -->
												<c:choose>
													<c:when test="${item.delteCheck eq 'Y'}">
														<tr>
															...
															<td>
																<div class="hidden-sm hidden-xs btn-group">
																	...
																	<button class="btn btn-xs btn-danger" id="btnDelete"
																		name="btnDelete" onclick="rowDelete(this)">
																...
																<div class="table-detail">
																	<div class="row">
																		...
																		<div class="col-xs-12 col-sm-7">
																			...
																			<div
																				...
																				<div class="profile-info-row">
																					...
																					<div class="profile-info-value">
																						<span>${item.boardUdate}</span>
																					</div>
																				</div>
																				<!-- 이 영역은 추후 다시 사용할지 몰라 살려둠 -->
																				<!-- <div class="profile-info-row">
																		...
																		<div class="col-xs-12 col-sm-3">
																			<div class="space visible-xs"></div>
																			<h4 class="header blue lighter less-margin">특이사항
																				메모</h4>
																			...
																			<form>
																				<fieldset>
																					<textarea class="width-100" resize="none"
																						name="manageContent"
																						placeholder="${item.manageContent}"></textarea>
																				</fieldset>
													...
													<c:when test="${item.delteCheck eq 'N'}">
														<tr>
															<td>이 행은 삭제된 행입니다.</td>
														</tr>
													</c:when>
